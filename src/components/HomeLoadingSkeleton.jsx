...
{[...Array(10)].map((item,index)=>
  <div key={index} role="status" className="p-4 w-full rounded border border-gray-200 shadow animate-pulse md:p-6 dark:border-gray-700 mb-10">
    <div className="flex justify-center items-center mb-4 h-[35rem] bg-gray-300 rounded dark:bg-gray-700">
